angular
    .module('com.amarsoft.mobile.controllers.indCustomerInspect.list', [])
	.controller('indCustomerInspectListController',function ($scope,$rootScope,$list,$cordovaFileTransfer,$timeout,$sce,$ionicModal,$detail,$model,$group,
		...
		var param = {
			...
			methodName : "getIndCustomerInspectList",
			menuTitle : "个人定检",
			flag : true,
			Transaction:"null"
		}
		...
		var InspectEntCuschooseCustomer = function(uiGridParam){
    		...
    		$scope.doClickSure = function(){
    			...
    			$rootScope.gotoCheckSelect({
    				selName:"SelectInspectCustomer",InspectType:"040010"},$scope.UIGridSelectedRow);
...
//	    				Item:item,selName:"SelectInspectCustomer",InspectType:"040010"});
//	    		},100)
//	    	}) 
	    }
	    
	    //删除按钮-（删除一条贷后检查记录）--个人定检
